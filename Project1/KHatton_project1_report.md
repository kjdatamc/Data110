...
During the COVID-19 pandemic, the news would often show a heatmap of COVID cases by state (see above). It used *total number of cases*. Nearly all of the time, the map would show states like CA, TX, FL, NY in the darkest (highest number of cases) color, and states like WY, AK, ND, SD, in the lightest (lowest number of cases) color. Seeing the largest and smallest states grouped like this made me wonder if the map was any different from a heatmap of population by state, so I pulled 2020 Census data and created a population heatmap (see below). It seems there were only a handful of differences.

![Image of 2020 Population Heatmap TO ADD](https://github.com/kjdatamc/Data110/blob/8bee062268ca45d3006c8241cbf258c55d665bcc/Project1/placeholder.png)
...
```
### Correlation Matrix
![Image of Correlation Matrices TO ADD](https://github.com/kjdatamc/Data110/blob/8bee062268ca45d3006c8241cbf258c55d665bcc/Project1/placeholder.png)
...
![Image of Regional Bar Graphs TO ADD](https://github.com/kjdatamc/Data110/blob/8bee062268ca45d3006c8241cbf258c55d665bcc/Project1/placeholder.png)
...
![Image of Cause of Death by Age Line Graph TO ADD](https://github.com/kjdatamc/Data110/blob/8bee062268ca45d3006c8241cbf258c55d665bcc/Project1/placeholder.png)
...
![Image of Unintentional Injury Hidden Trend Line Graph TO ADD](https://github.com/kjdatamc/Data110/blob/8bee062268ca45d3006c8241cbf258c55d665bcc/Project1/placeholder.png)
